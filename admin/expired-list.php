			...
			<div class="center_content">
				 <div id="right_wrap">
					<div id="right_content">
			            ...
			            <h2><center>DANH SÁCH SÁCH ĐÃ HẾT HẠN</center></h2>
			            <table id="rounded-corner">
			              ...
			              <tbody>
			                <tr class="odd">
			                  ...
			                  <td>Tin học</td>
			                  <td>1/5/2017</td>
			                  <td><a href="#"><img src="images/trash.gif"></a></td>
				...
				<div class="sidebar" id="sidebar">
					...
					<ul>
						...
						<li><a href="expire-list.php">Danh sách sách sắp quá hạn</a></li>
						<li><a href="expired-list.php"  class="selected">Danh sách sách đã hết hạn</a></li>
